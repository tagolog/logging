...
namespace Tagolog.NLog
{
    ...
    public class TagologMdcLayoutRenderer : LayoutRenderer
    {
        ...
        protected override void Append( StringBuilder builder, LogEventInfo logEvent )
        {
            ...
            {
                InternalLogger.Trace( "TagologMdcLayoutRenderer: tagolog context is null or empty." );
                return;
            }
            ...
            InternalLogger.Trace( "TagologMdcLayoutRenderer: [Tags.Count={0}] [BuiltInTags.Count={1}]", tags.Count, builtInTags.Count );
